...
| **`BeforeCreateFirstUser`| Array of components to inject into the built-in CreateFirstUser, _before_ the default create first user form.                                                                                          |
| **`BeforeLogin`**     | Array of components to inject into the built-in Login, _before_ the default login form.                                                                                                                   |
| **`AfterCreateFirstUser`| Array of components to inject into the built-in CreateFirstUser, _after_ the default create first user form.                                                                                            |
